...
void drawAbout() {
  ...
  drawLabelValue(10, "Chip ID:= %04X", String((uint16_t)(chipid >> 32)));
  drawLabelValue(11, "%08X\n", String((uint32_t)chipid));
  ...
  gfx.setTextAlignment(TEXT_ALIGN_LEFT);
  gfx.setColor(MINI_YELLOW);
  gfx.drawString(16, 250, "Last Reset: ");
  gfx.setColor(MINI_WHITE);
...
void bounce() {
  ...
  Serial.print ("St1..."); Serial.println(reading1);
  Serial.print ("St2..."); Serial.println(reading2);
  Serial.print ("St3..."); Serial.println(reading3);
}
